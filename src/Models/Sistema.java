...
public class Sistema {
    ...
    private Utilizador utilizador; //utili
     ...
     */
    public Sistema(Map<String, GPS> gps, Map<String, Utilizador> utilizadores, Map<String, Loja> loja,
    ...
    /**
     * Função que permite a um utilizador fechar/terminar a sessão.
     */
